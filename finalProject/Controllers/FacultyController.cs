...
namespace finalProject.Controllers
{
    ...
    public class FacultyController : ControllerBase
    {
        ...
        public FacultyController(IServiceManager serviceManager)
        {
        ...
        public async Task<IActionResult> Get_f_Compulsory()
        {
            try
            {
                ...
                var courses = await _serviceManager.CourseService.Faculty_Compulsories(userId);
        ...
        public async Task<IActionResult> Get_f_Electives()
        {
            ...
            {
                var userId = int.Parse(User.FindFirstValue("id")!);
                var courses = await _serviceManager.CourseService.Faculty_Electives(userId);
